...
/**
 * The repository for Travels
 */
class TravelRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
     ...
     * @return void
     */
    public function findOnList() {
    	$query = $this->createQuery();
    	return $query->matching(
    			$query->logicalAnd(
   					$query->equals('show_in_list', '1')
				)
		)
