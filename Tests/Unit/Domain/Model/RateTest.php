...
/**
 * Test case for class \T3Dev\Escortmodels\Domain\Model\Rate.
 *
 ...
 */
class RateTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \T3Dev\Escortmodels\Domain\Model\Rate();
	}
