...
/**
 * Test case for class \T3Dev\Escortmodels\Domain\Model\Language.
 *
...
{
	/**
	 * @var \T3Dev\Escortmodels\Domain\Model\Language
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \T3Dev\Escortmodels\Domain\Model\Language();
	}
