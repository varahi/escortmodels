...
/**
 * Test case for class \T3Dev\Escortmodels\Domain\Model\ShoeSize.
 *
 ...
 */
class ShoeSizeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \T3Dev\Escortmodels\Domain\Model\ShoeSize();
	}
