...
/**
 * Test case for class \T3Dev\Escortmodels\Domain\Model\Nationality.
 *
 ...
 */
class NationalityTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \T3Dev\Escortmodels\Domain\Model\Nationality();
	}
